...
export default function RegisterView() {
    ...
    //revisar que los pass sean iguales
    const password = watch('password')
    
    //enviar datos al back
    const handleRegister = async (formData:RegisterForm) =>{
        try {
            //Saco la url del postman 
        ...
        <>
                ...
                <div className="grid grid-cols-1 space-y-3">
                    ...
                    <input
                        ...
                        {...register('email',{required:'El email es obligatorio',
                            pattern: { //Validar el formato del mail
                                value: /\S+@\S+\.\S+/,
                ...
                <div className="grid grid-cols-1 space-y-3">
                    ...
                    <input
                        ...
                        {...register('password_confirmation',{required:'El password es obligatorio',
                            //Si el valor , es igual a password, pasa, sino , no son iguales
            ...
            <nav className='mt-10'>
                <Link
                    ...
                    to='/auth/login'>Volver al Login</Link>
            </nav>
        </>
